...
public class MainActivity extends Activity
    ...
    public void startMyService(String stockSymbol) {
        ...
        intent.putExtra(MyService.FILENAME, "njwtest.html"); //local filename
        intent.putExtra(MyService.URL,
                "http://www.vogella.com/index.html"); //todo: pass the yql...
        startService(intent);
        this.getActionBar().setTitle("Service started");
    }
